...
import 'C:/Users/DELL/breastApp/node_modules/react-medium-image-zoom/dist/styles.css'
  ...
  render() {
    ...
    return (
      ...
      <header>
        ...
        <Zoom  > 
  <picture>
    <source  media="(max-width: 400px)" srcSet={this.state.imgList[this.state.index]} />
          <img style={{borderRadius: 8, boxShadow: '10px 10px 20px black', height: 400, width: 400}} src={this.state.imgList[this.state.index]} alt="" /></picture></Zoom><br />
          <div style={{width: 400, marginLeft: '15%'}}><p style={{boxShadow: '10px 10px 20px black', borderStyle: "ridge", borderBlockWidth: 100, borderRadius: 8, borderColor: "black", fontSize: 35, fontFamily: "KeterYG", fontWeight: "bold"}}>{this.state.string} </p></div>
        </div>
        <div>
